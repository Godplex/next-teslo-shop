    ...
    useEffect(() => {
        ...
        if (Cookies.get('firstName')) {
            let shippingAddress: ShippingAddress = {
                ...
                address2: Cookies.get('address2') ? Cookies.get('address2')! : '',
                zip: Cookies.get('zip') ? Cookies.get('zip')! : '',
                city: Cookies.get('city') ? Cookies.get('city')! : '',
                country: Cookies.get('country') ? Cookies.get('country')! : '',
